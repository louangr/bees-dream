...
const columns: readonly Column[] = [
  {
    id: "informations.firstname",
    label: "Prénom",
    minWidth: 170,
    format: (u) => u.informations?.firstname,
  },
  {
    id: "informations.lastname",
    label: "Nom",
    minWidth: 170,
    format: (u) => u.informations?.lastname,
  },
  { id: "login", label: "Login", minWidth: 170, format: (u) => u.login },
  {
    id: "informations.company",
    label: "Entreprise",
    minWidth: 170,
    format: (u) => u.informations?.company,
  },
  {
    id: "age",
    label: "Age",
    minWidth: 170,
    format: (u) => u.informations?.age?.toString(),
  },
];
...
const BeeKeeperList: React.FC = () => {
  ...
  const [modalMode, setModalMode] = React.useState<BeeKeeperModalMode>(
    BeeKeeperModalMode.Edition
  );
